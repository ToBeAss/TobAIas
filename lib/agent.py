...
class Agent:
    ...
    def invoke(self, user_input):
        ...
        retrieved_docs = self._db.invoke(user_input)

        # Step 2: Formulate a structured prompt using retrieved context and add it to the message history
        context = f"\n{retrieved_docs}" if retrieved_docs else "I couldn't find any relevant documents. I'll answer based on my general knowledge."
